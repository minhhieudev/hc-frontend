...
const CustomTableKeyWord = <T extends { _id?: string }>(
    ...
    >
      ...
      <Table
        ...
        classNames={{
          ...
          wrapper: "shadow-none pt-0 px-0 rounded-none m-0 ",
          table: "p-0 m-0 ",
          tbody: "rounded-none ",
          thead: "[&>tr]:first:rounded-none sticky z-20 [&>tr]:first:shadow  ",
          td: "border-b-[1px] border-solid border-[#F7F9FA] px-[12px] py-2 text-base font-normal text-[#090A0A] ",
          th: " border-solid  text-sm font-bold text-[#72777A]  rounded-none bg-white shadow-none bg-[#F7F9FA]",
        }}
        {...tableProps}
        isHeaderSticky
      >
...
export default CustomTableKeyWord;
